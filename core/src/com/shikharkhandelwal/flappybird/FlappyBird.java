package com.shikharkhandelwal.flappybird;
...
public class FlappyBird extends ApplicationAdapter {
	...
	public void create () {
        ...
        distanceBetweenTubes=Gdx.graphics.getWidth()/2+240;
        ...
        if(gameState==1) {
            ...
            for(int i=0;i<numberOfTubes;i++){
                if(tubeX[i]< -topTube.getWidth()){
                    ...
                    if(tubeX[scoringTube]<Gdx.graphics.getWidth()/2-bottomTube.getWidth()/2){
                        score++;
            ...
            font.draw(batch, score+"",Gdx.graphics.getWidth()/2-30,Gdx.graphics.getHeight()/2-gameOver.getHeight()/6 );
